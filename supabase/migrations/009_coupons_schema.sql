-- Migration: Coupons Schema
-- Description: Create tables for coupon management system
-- Created: 2025-01-17
...
-- Add comments to coupon_usages table
...
-- Admins and organizers can view all coupons
...
-- Admins and organizers can create coupons
...
-- Admins and organizers can update coupons
...
-- Admins and organizers can delete (disable) coupons
...
-- RLS Policies for coupon_usages table
...
-- System can insert coupon usages (during checkout)
...
-- For example, using pg_cron extension or application-level cron job
